...
<html>
    ...
    <body>
        <form action="<%= request.getContextPath() %>/SolicitacaoEmpresaServlet" class="formularioEmpresa" method="post"> 
            ...
            <div class="field">
                ...
                <input type="text" id="cnpjid" name="cnpj" placeholder="CNPJ"required>
            </div>
